...
Step 3 (2 pts). Calculate and output the number of 1 gallon cans needed to paint the wall.
Extra paint may be left over. Hint: Use ceil() from the math module to round up to the nearest gallon (int). Submit for grading to confirm 4 tests pass.
...
paint_cost = cost_paint_can * cans_needed
sales_tax = 0.07 * paint_cost
total_cost = sales_tax + paint_cost
